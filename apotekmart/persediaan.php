...
if (isset($_POST['cari'])) {
    $keywordPencarian = $_POST['pencarian'];
    $dataSemuaObat = pencarianDataObat($keywordPencarian);
}
?>
...
<head>
    <title>Halaman Persediaan</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    ...
    <div class="container">
        ...
        <div class="pencarian mt-3">
            <form action="" method="post">
                <input type="text" name="pencarian" placeholder="Cari Data" class="form-control">
                <button type="submit" class="btn btn-primary mb-3 mt-1" name="cari">Cari Data Obat</button>
            </form>
        </div>
            ...
            <tbody>
                <?php foreach ($dataSemuaObat as $data) : ?>
                    <tr>
                        ...
                        <td><?= $data['farmasi'] ?></td>
                        <td>
                            <a href="prosesPersediaan/prosesStok.php?id_obat=<?php echo $data['id_obat'] ?>" class="btn btn-primary"><i class="fas fa-edit"></i></a>
                        </td>
                    </tr>
                <?php endforeach ?>
            </tbody>
